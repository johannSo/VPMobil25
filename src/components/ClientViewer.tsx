  ...
  return (
    <div className="mx-auto max-w-6xl animate-in fade-in duration-700">
      <header className="mb-10 space-y-8">
        ...
        {data && (
          <div className="bg-white dark:bg-zinc-950 p-6 rounded-3xl border-2 border-zinc-100 dark:border-zinc-900 shadow-sm space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-zinc-50 dark:bg-zinc-900/50 border-2 border-zinc-100 dark:border-zinc-900 p-12 rounded-3xl text-center">
